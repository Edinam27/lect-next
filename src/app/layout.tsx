...
import MobileNavigation, { QuickActionFAB } from "@/components/mobile/MobileNavigation";
...
export const metadata: Metadata = {
  title: "UPSA Attendance Management System",
  description: "Lecturer Attendance Management System for UPSA Graduate School with Class Representative Verification",
  keywords: ["attendance", "management", "UPSA", "lecturer", "education", "verification"],
  authors: [{ name: "UPSA Graduate School" }],
  creator: "UPSA Graduate School",
  publisher: "UPSA Graduate School",
  formatDetection: {
    email: false,
    address: false,
    telephone: false,
  ...
  openGraph: {
    type: "website",
    siteName: "UPSA Attendance Management",
    title: "UPSA Attendance Management System",
    description: "Efficient lecturer attendance tracking with class representative verification",
  },
  twitter: {
    card: "summary",
    title: "UPSA Attendance Management System",
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <head>
        {/* PWA Meta Tags */}
        <meta name="application-name" content="UPSA Attendance" />
        <meta name="apple-mobile-web-app-capable" content="yes" />
        <meta name="apple-mobile-web-app-status-bar-style" content="default" />
        <meta name="apple-mobile-web-app-title" content="UPSA Attendance" />
